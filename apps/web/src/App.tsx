...
const AutomationSendsPage = lazy(() =>
  import('@/pages/automations/AutomationSendsPage').then((m) => ({
    default: m.AutomationSendsPage,
  })),
);
        ...
        <Suspense fallback={<RouteFallback />}>
          <Routes>
            ...
            >
              ...
              <Route path="automations/sends" element={<AutomationSendsPage />} />
