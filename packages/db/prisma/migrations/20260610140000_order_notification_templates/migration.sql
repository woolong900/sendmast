-- Seed the default order-confirmation / order-shipped system templates
-- (block-based easy-email designJson). Idempotent via ON CONFLICT.
...
<mj-html-attribute class="easy-email" multiple-attributes="false" attribute-name="responsive" responsive="true"></mj-html-attribute>
        ...
        <mj-text font-weight="400" />
          ...
          <mj-body background-color="#f4f4f5" width="600px" ><mj-section padding="40px 0 16px" border="none" direction="ltr" text-align="center" background-repeat="repeat" background-size="auto" background-position="top center" background-color="#f4f4f5" ><mj-column padding="0px 0px 0px 0px" border="none" vertical-align="top" width="100%" ><mj-text padding="0 20px" align="left" font-size="26px" color="#111827" >{{shop_name}}</mj-text></mj-column></mj-section><mj-section padding="0 20px 20px" background-repeat="repeat" background-size="auto" background-position="top center" border="none" direction="ltr" text-align="center" background-color="#f4f4f5" ><mj-column padding="36px 32px" border="none" vertical-align="top" width="100%" background-color="#ffffff" border-radius="10px" ><mj-text padding="0 0 12px" align="left" font-size="24px" color="#111827" font-weight="600" >Your order is on its way!</mj-text><mj-text padding="0 0 24px" align="left" font-size="16px" color="#555555" line-height="1.6" >Hi {{full_name}}, good news — your order {{order_no}} has shipped and is on its way to you. Track your delivery using the button below.</mj-text><mj-text padding="0 0 24px" align="left" font-size="14px" color="#111827" line-height="1.8" ><table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-spacing:0;border-collapse:collapse;background:#f9fafb;border:1px solid #eceff3;border-radius:8px;"><tr><td style="padding:14px 18px;font-size:14px;color:#6b7280;">Order</td><td align="right" style="padding:14px 18px;font-size:14px;color:#111827;font-weight:600;">{{order_no}}</td></tr><tr><td style="padding:0 18px 14px;font-size:14px;color:#6b7280;border-top:1px solid #eceff3;">Total</td><td align="right" style="padding:14px 18px;font-size:18px;color:#111827;font-weight:700;border-top:1px solid #eceff3;">{{order_total}}</td></tr></table></mj-text><mj-button align="center" background-color="#111827" color="#ffffff" font-weight="600" border-radius="6px" padding="16px 34px" inner-padding="10px 25px 10px 25px" line-height="120%" target="_blank" vertical-align="middle" border="none" text-align="center" href="{{tracking_url}}" font-size="16px" width="100%" >Track your shipment</mj-button></mj-column></mj-section><mj-section padding="8px 0 28px" background-repeat="repeat" background-size="auto" background-position="top center" border="none" direction="ltr" text-align="center" background-color="#f4f4f5" ><mj-column padding="0px 0px 0px 0px" border="none" vertical-align="top" width="100%" ><mj-text padding="0 20px" align="center" font-size="13px" color="#9ca3af" line-height="1.6" >You received this email because you placed an order with us. <a href="{{unsubscribe_url}}" style="color:#9ca3af;text-decoration:underline;">Unsubscribe</a></mj-text></mj-column></mj-section></mj-body></mjml > $mjml$,
  $html$<!doctype html>
<html lang="und" dir="auto" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    <title></title>
  ...
  $html$,
  $json${"subject":"Your order has shipped","subTitle":"","content":{"type":"page","data":{"value":{"breakpoint":"480px","headAttributes":"","font-size":"14px","font-weight":"400","line-height":"1.7","headStyles":[],"fonts":[],"responsive":true,"font-family":"-apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Arial, sans-serif","text-color":"#111827"}},"attributes":{"background-color":"#f4f4f5","width":"600px"},"children":[{"type":"section","data":{"value":{"noWrap":false}},"attributes":{"padding":"40px 0 16px","border":"none","direction":"ltr","text-align":"center","background-repeat":"repeat","background-size":"auto","background-position":"top center","background-color":"#f4f4f5"},"children":[{"type":"column","data":{"value":{}},"attributes":{"padding":"0px 0px 0px 0px","border":"none","vertical-align":"top","width":"100%"},"children":[{"type":"advanced_text","data":{"value":{"content":"{{shop_name}}"}},"attributes":{"padding":"0 20px","align":"left","font-size":"26px","color":"#111827"},"children":[]}]}]},{"type":"section","data":{"value":{"noWrap":false}},"attributes":{"padding":"0 20px 20px","background-repeat":"repeat","background-size":"auto","background-position":"top center","border":"none","direction":"ltr","text-align":"center","background-color":"#f4f4f5"},"children":[{"type":"column","data":{"value":{}},"attributes":{"padding":"36px 32px","border":"none","vertical-align":"top","width":"100%","background-color":"#ffffff","border-radius":"10px"},"children":[{"type":"advanced_text","data":{"value":{"content":"Your order is on its way!"}},"attributes":{"padding":"0 0 12px","align":"left","font-size":"24px","color":"#111827","font-weight":"600"},"children":[]},{"type":"advanced_text","data":{"value":{"content":"Hi {{full_name}}, good news — your order {{order_no}} has shipped and is on its way to you. Track your delivery using the button below."}},"attributes":{"padding":"0 0 24px","align":"left","font-size":"16px","color":"#555555","line-height":"1.6"},"children":[]},{"type":"advanced_text","data":{"value":{"content":"<table role=\"presentation\" width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" style=\"border-spacing:0;border-collapse:collapse;background:#f9fafb;border:1px solid #eceff3;border-radius:8px;\"><tr><td style=\"padding:14px 18px;font-size:14px;color:#6b7280;\">Order</td><td align=\"right\" style=\"padding:14px 18px;font-size:14px;color:#111827;font-weight:600;\">{{order_no}}</td></tr><tr><td style=\"padding:0 18px 14px;font-size:14px;color:#6b7280;border-top:1px solid #eceff3;\">Total</td><td align=\"right\" style=\"padding:14px 18px;font-size:18px;color:#111827;font-weight:700;border-top:1px solid #eceff3;\">{{order_total}}</td></tr></table>"}},"attributes":{"padding":"0 0 24px","align":"left","font-size":"14px","color":"#111827","line-height":"1.8"},"children":[]},{"type":"advanced_button","data":{"value":{"content":"Track your shipment"}},"attributes":{"align":"center","background-color":"#111827","color":"#ffffff","font-weight":"600","border-radius":"6px","padding":"16px 34px","inner-padding":"10px 25px 10px 25px","line-height":"120%","target":"_blank","vertical-align":"middle","border":"none","text-align":"center","href":"{{tracking_url}}","font-size":"16px","width":"100%"},"children":[]}]}]},{"type":"section","data":{"value":{"noWrap":false}},"attributes":{"padding":"8px 0 28px","background-repeat":"repeat","background-size":"auto","background-position":"top center","border":"none","direction":"ltr","text-align":"center","background-color":"#f4f4f5"},"children":[{"type":"column","data":{"value":{}},"attributes":{"padding":"0px 0px 0px 0px","border":"none","vertical-align":"top","width":"100%"},"children":[{"type":"advanced_text","data":{"value":{"content":"You received this email because you placed an order with us. <a href=\"{{unsubscribe_url}}\" style=\"color:#9ca3af;text-decoration:underline;\">Unsubscribe</a>"}},"attributes":{"padding":"0 20px","align":"center","font-size":"13px","color":"#9ca3af","line-height":"1.6"},"children":[]}]}]}]}}$json$::jsonb,
  now(),
  now()
)
ON CONFLICT ("id") DO UPDATE SET
