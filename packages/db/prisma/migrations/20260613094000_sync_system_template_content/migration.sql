UPDATE "email_templates" SET "html" = $template$<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>My Store</title>
...
<tr><td style="padding:0 8px 20px;font-size:25px;font-weight:600;color:#202223;">My Store</td></tr>
...
<tr><td align="center" style="padding:24px 16px 0;font-size:12px;line-height:1.6;color:#8c9196;">Don't want to receive cart reminders from My Store?<br><a href="{{unsubscribe_url}}" style="color:#6d7175;">Unsubscribe</a></td></tr>
</table></td></tr></table></body></html>$template$, "mjml" = NULL, "design_json" = NULL, "updated_at" = now() WHERE "id" = '00000000-0000-4000-8000-000000000004' AND "scope" = 'system'::"template_scope";
...
<tr><td align="center" style="padding:24px 16px 0;font-size:12px;line-height:1.6;color:#8c9196;">You received this email because you placed an order with My Store.<br><a href="{{unsubscribe_url}}" style="color:#6d7175;">Unsubscribe</a></td></tr>
</table></td></tr></table></body></html>$template$, "mjml" = NULL, "design_json" = NULL, "updated_at" = now() WHERE "id" = '00000000-0000-4000-8000-000000000005' AND "scope" = 'system'::"template_scope";
...
<tr><td align="center" style="padding:24px 16px 0;font-size:12px;line-height:1.6;color:#8c9196;">You received this email because you placed an order with My Store.<br><a href="{{unsubscribe_url}}" style="color:#6d7175;">Unsubscribe</a></td></tr>
</table></td></tr></table></body></html>$template$, "mjml" = NULL, "design_json" = NULL, "updated_at" = now() WHERE "id" = '00000000-0000-4000-8000-000000000006' AND "scope" = 'system'::"template_scope";
...
<table class="wrap" role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;">
<tr><td style="padding:0 8px 20px;font-size:25px;font-weight:600;color:#202223;">My Store</td></tr>
<tr><td style="background:#ffffff;border:1px solid #e1e3e5;border-radius:8px;overflow:hidden;"><img src="https://app.sendmast.com/assets/automation-welcome-banner-v2.jpg" width="600" alt="Welcome" style="display:block;width:100%;height:auto;border:0;">
<div class="pad" style="padding:38px 42px 42px;">
<h1 style="margin:0 0 14px;font-size:28px;line-height:1.25;font-weight:600;">Welcome to My Store</h1>
...
<tr><td align="center" style="padding:24px 16px 0;font-size:12px;line-height:1.6;color:#8c9196;">You received this email because you created an account with My Store.<br><a href="{{unsubscribe_url}}" style="color:#6d7175;">Unsubscribe</a></td></tr>
</table></td></tr></table></body></html>$template$, "mjml" = NULL, "design_json" = NULL, "updated_at" = now() WHERE "id" = '00000000-0000-4000-8000-000000000007' AND "scope" = 'system'::"template_scope";
...
<table role="presentation" cellpadding="0" cellspacing="0"><tr><td bgcolor="#2f6f55" style="border-radius:6px;background:#2f6f55;"><a href="{{review_url}}" target="_blank" style="display:inline-block;padding:14px 24px;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;">Write a review</a></td></tr></table>
</div></td></tr>
<tr><td align="center" style="padding:24px 16px 0;font-size:12px;line-height:1.6;color:#8c9196;">You received this email after shopping with My Store.<br><a href="{{unsubscribe_url}}" style="color:#6d7175;">Unsubscribe</a></td></tr>
</table></td></tr></table></body></html>$template$, "mjml" = NULL, "design_json" = NULL, "updated_at" = now() WHERE "id" = '00000000-0000-4000-8000-000000000008' AND "scope" = 'system'::"template_scope";
...
<table role="presentation" cellpadding="0" cellspacing="0"><tr><td bgcolor="#2f6f55" style="border-radius:6px;background:#2f6f55;"><a href="{{payment_url}}" target="_blank" style="display:inline-block;padding:14px 24px;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;">Update payment</a></td></tr></table>
</div></td></tr>
<tr><td align="center" style="padding:24px 16px 0;font-size:12px;line-height:1.6;color:#8c9196;">Need help? Reply to this email and the My Store team will assist you.<br><a href="{{unsubscribe_url}}" style="color:#6d7175;">Unsubscribe</a></td></tr>
</table></td></tr></table></body></html>$template$, "mjml" = NULL, "design_json" = NULL, "updated_at" = now() WHERE "id" = '00000000-0000-4000-8000-000000000009' AND "scope" = 'system'::"template_scope";
...
<table role="presentation" cellpadding="0" cellspacing="0" style="margin-bottom:24px;"><tr><td valign="top" style="padding:4px 12px 16px 0;color:#2f6f55;">&#9679;</td><td style="padding-bottom:16px;font-size:14px;line-height:1.5;"><strong>Refund issued</strong><br><span style="color:#6d7175;">{{refund_date}}</span></td></tr><tr><td valign="top" style="padding:4px 12px 0 0;color:#2f6f55;">&#9679;</td><td style="font-size:14px;line-height:1.5;"><strong>Expected arrival</strong><br><span style="color:#6d7175;">Within 5–10 business days</span></td></tr></table>
<table role="presentation" cellpadding="0" cellspacing="0"><tr><td bgcolor="#2f6f55" style="border-radius:6px;background:#2f6f55;"><a href="{{order_url}}" target="_blank" style="display:inline-block;padding:14px 24px;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;">View order details</a></td></tr></table>
</div></td></tr>
<tr><td align="center" style="padding:24px 16px 0;font-size:12px;line-height:1.6;color:#8c9196;">You received this email because a refund was issued by My Store.<br><a href="{{unsubscribe_url}}" style="color:#6d7175;">Unsubscribe</a></td></tr>
</table></td></tr></table></body></html>$template$, "mjml" = NULL, "design_json" = NULL, "updated_at" = now() WHERE "id" = '00000000-0000-4000-8000-000000000010' AND "scope" = 'system'::"template_scope";
...
<table role="presentation" cellpadding="0" cellspacing="0"><tr><td bgcolor="#2f6f55" style="border-radius:6px;background:#2f6f55;"><a href="{{rewards_url}}" target="_blank" style="display:inline-block;padding:14px 24px;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;">Redeem rewards</a></td></tr></table>
</div></td></tr>
<tr><td align="center" style="padding:24px 16px 0;font-size:12px;line-height:1.6;color:#8c9196;">You received this email as a member of My Store Rewards.<br><a href="{{unsubscribe_url}}" style="color:#6d7175;">Unsubscribe</a></td></tr>
</table></td></tr></table></body></html>$template$, "mjml" = NULL, "design_json" = NULL, "updated_at" = now() WHERE "id" = '00000000-0000-4000-8000-000000000011' AND "scope" = 'system'::"template_scope";
