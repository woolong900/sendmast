/** System default orderShipped template — block-based easy-email designJson. */
export const ORDER_SHIPPED_TEMPLATE_ID = "00000000-0000-4000-8000-000000000006";
export const ORDER_SHIPPED_SUBJECT = "Your order has shipped";

export const orderShippedDesignJson = {
        ...
        "children": [
          {
            ...
            "children": [
              ...
              },
              {
                ...
                "data": {
                  "value": {
                    "content": "Hi {{full_name}}, good news — your order has shipped and is on its way to you."
                  }
                },
                "attributes": {
                  "padding": "0 0 20px",
